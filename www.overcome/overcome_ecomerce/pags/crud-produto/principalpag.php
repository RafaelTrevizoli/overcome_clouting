...
<header>
    <nav>
        ...
        <div class="container-header-3">
            <div>
                <input class="barra-pesquisa" type="text" id="txtbusca" placeholder="    Oque você está procurando?">
            </div>

            <div class="container-header-4">
                <a href="painel.php"><img src="../img/caneta.png" class="icones-hover" width="30px" alt=""></a>
            </div>
    ...
    <div class="categorias-header">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="meias.php"><img class="icones-hover" src="../img/meias.png" width="30px" alt=""></a><br>Meias
            </li>
