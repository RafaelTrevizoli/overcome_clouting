...
<body>
    <header>
        ...
        <div class="categorias-header">
            ...
            <ul class="nav-menu">
                <li><a href="principalpag-user.php"><img class="icones-hover" src="../img/caixaAberta.png" width="30px"
                            alt=""></a><br>Todos os produtos</li>
                <li><a href="#"><img class="icones-hover" src="../img/colete.png" width="30px" alt=""></a><br>Jaquetas
                </li>
